...
export const LANGUAGE_MATRIX: LanguageMatrixItem[] = [
  ...
  },
  {
    ...
    nativeSpeakersM: 13,
    demographicTrajectory: "Estable",
    demographicGrowthNote: "Población de Grecia y Chipre con una diáspora histórica influyente en EE. UU., Australia y Europa.",
    culturalSoftPowerScore: 89,
    culturalNotes: "Cuna de la filosofía occidental, el teatro trágico, la mitología, la democracia ateniense y la literatura homérica.",
    digitalFootprintRank: 24,
    digitalFootprintNote: "Vasto patrimonio académico, enciclopédico y científico documentado en su alfabeto milenario.",
    mostStudiedRank: 16,
    economicWeightTrillionUSD: 0.35,
    economicNote: "Líder mundial indiscutible en transporte marítimo (la mayor flota de mercantes del planeta) y turismo de primer nivel.",
    fsiDifficultyTier: "Tier 3 (36 sem)",
    fsiSpanishEquiv: "Moderado",
    geographicDispersion: "Regional concentrado",
    dialectalFragmentation: "Baja / Estandarizada",
    dialectalNote: "Griego moderno estándar (Demótico) altamente unificado; dialectos chipriota, cretense y póntico.",
    untranslatedTreasures: "Tratados bizantinos de teología y estética, poesía lírica de Cavafis, Seferis y Elitis (Premios Nobel) y novelas profundas de Kazantzakis.",
    orthographicPhoneticCurve: "Alfabeto griego histórico de 24 letras; 5 vocales puras como el español; dígrafos vocálicos (αι=e, ει=i, ου=u).",
    readingTransparencyLevel: "Fácil",
    readingTransparencyNote: "Alfabeto griego muy regular con reglas fijas de dígrafos (αι=e, οι/ει=i, ου=u).",
    listeningSpellingLevel: "Moderada",
    listeningSpellingNote: "Varios grafemas suenan /i/ (ι, η, υ, ει, οι, υι) por iotacismo histórico y dos para /o/ (ο, ω).",
    regions: ["Europa"]
  },
  {
    id: "he",
