...
import { X, Moon, Sun, Globe, BookOpen, Key, Check, Info, ExternalLink, Flag, Trash2, User } from "lucide-react";
...
export interface UserSettings {
  ...
  currentlyLearning: string[]; // Language codes
  geminiApiKey?: string;
}
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="text-xs font-black uppercase tracking-wider text-gray-400">
                {t.currentlyLearningLabel(currentlyLearning.length)}
              </label>
